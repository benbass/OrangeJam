...
class ContinuousPlayback extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Check automatic playback state and set continuous mode accordingly
    final automaticPlaybackCubit =
        BlocProvider.of<AutomaticPlaybackCubit>(context);
    continuousPlaybackModeCubit
        .setContinuousPlaybackMode(automaticPlaybackCubit.state);
    isLoopModeCubit.setLoopMode(!automaticPlaybackCubit.state);
    //
        ...
        return IconButton(
          onPressed: () {
            ...
            continuousPlaybackMode
                ? continuousPlaybackModeCubit.setContinuousPlaybackMode(false)
                : continuousPlaybackModeCubit.setContinuousPlaybackMode(true);
            continuousPlaybackMode
